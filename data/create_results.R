...
#' saveRDS(results_factorial_true, "data/results_factorial_true.rds")
#' saveRDS(results_factorial_complement_true, "data/results_factorial_complement_true.rds")
#' saveRDS(results_complement_true, "data/results_complement_true.rds")
#'
#' saveRDS(importance, "data/importance.rds")
#'
# studies <- read.csv("data/studies.csv")
# saveRDS(studies, "data/studies.rds")
